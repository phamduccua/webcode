...
<div class="head">
    ...
    <a class="button button-exam" href="/demo2-0.0.1-SNAPSHOT/api/contest/${id}/question">Bài tập</a>
    <a class="button button-history" href="/demo2-0.0.1-SNAPSHOT/api/contest/${id}/history">Lịch sử</a>
    <a class="button button-rank" href="/demo2-0.0.1-SNAPSHOT/api/contest/${id}/ranking">Bảng xếp hạng</a>
    <a class="button button-back" href="/demo2-0.0.1-SNAPSHOT/api/question">Trở về trang chủ</a>
...
<script>
    function update_password(){
        window.location.href = "/demo2-0.0.1-SNAPSHOT/api/update_password/${idUser}";
    }
</script>
