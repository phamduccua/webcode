        ...
        <table>
            ...
            <c:forEach var="item" items="${listProblem}" varStatus="status">
                <tr class="col-12">
                    ...
                    <td class="col-8"><a class="open" href="/web/admin/assignment-${item.code}" />${item.title}</td>
                    <td class="col-2">
...
<script>
    function create_problem(){
        window.location.href = "/web/admin/contest-create_problem-${contestDTO.id}"
    }
...
<script>
    ...
    function doi_trang(code){
        window.location.href = "/web/admin/problem_contest-edit-" + code;
    }
</script>
<script>
